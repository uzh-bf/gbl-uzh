...
- Next: Commit the Layer 3 repair, run the required separate correctness and simplification reviews, then create recovery refs and cascade-rebase layers 4–5 without changing stack topology or draft state.
