...
export type PastResultsQuery = { __typename?: 'Query', result?: { __typename?: 'PlayerState', currentGame?: { __typename?: 'Game', id: string, status: GameStatus } | null } | null, pastResults?: Array<{ __typename?: 'PlayerResult', id: string, type?: PlayerResultType | null, facts?: any | null, player: { __typename?: 'Player', id: string, role?: string | null, name: string, avatar: string, location: string, color: string, facts: any, experience: number, experienceToNext: number, completedLearningElementIds: Array<number>, visitedStoryElementIds: Array<number>, level: { __typename?: 'PlayerLevel', id: string, index: number } }, period: { __typename?: 'Period', id: string, index: number, facts: any }, segment?: { __typename?: 'PeriodSegment', id: string, index: number, facts: any } | null }> | null };
