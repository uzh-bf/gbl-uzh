...
function Achievement({
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-0 bottom-0 rounded bg-white/90 p-[2px] text-xs text-red-700">
        {xpReward}
      </div>
      {count > 1 && (
        <div className="absolute top-0 right-0 rounded bg-white/90 p-[2px] text-xs text-red-700">
          {count}x
        </div>
      )}
    </div>
