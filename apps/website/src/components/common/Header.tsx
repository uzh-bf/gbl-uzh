...
function H2({ children, className, align }: Props) {
  ...
  if (align === 'left') {
    styles =
      'mb-2 text-xl sm:text-2xl lg:text-3xl md:mb-4 text-left font-kollektif font-bold md:text-left'
  } else if (align === 'right') {
    styles =
      'mb-2 text-xl sm:text-2xl lg:text-3xl md:mb-4 text-left font-kollektif font-bold md:text-right'
  } else {
    styles =
