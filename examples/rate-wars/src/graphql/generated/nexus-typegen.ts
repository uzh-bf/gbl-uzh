...
export interface NexusGenInputs {
  ...
  PeriodFactsScenarioInput: {
    // input type
    baseDefaultRate: number | null // Float
    centralBankRate: number | null // Float
    depositPool: number | null // Float
    depositSensitivity: number | null // Float
    fixedCost: number | null // Float
    loanDemand: number | null // Float
    loanSensitivity: number | null // Float
    lossGivenDefault: number | null // Float
    seed: number | null // Int
    shockScale: number | null // Float
  }
  PeriodSegmentFactsInput: {
    // input type
    shockOverride?: number | null // Float
  }
}
