...
function LearningElements() {
  ...
  const periods: Period[] = (currentGame?.periods ?? []) as any
  const learningElements: LearningElementType[] = (currentGame
    ?.activePeriod?.activeSegment?.learningElements ?? []) as any
