...
function Footer() {
  return (
    <footer className="z-10 flex flex-col justify-between flex-initial p-4 text-sm text-gray-600 bg-white border-t-2 border-uzh-red-20000 md:flex-row border-top md:text-base">
      ...
      <p className="order-2 text-center text-gray-600 md:order-1 md:text-left">
        <span className="font-bold md:order-0.1 ">GBL @ DBF</span>
        <br />
